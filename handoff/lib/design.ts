// handoff/lib/design.ts
// Centralizes severity + status logic. Both `AlertsTable.tsx` and the new
// `TimelineScreen.tsx` / `AlertQueueScreen.tsx` should import from here
// instead of duplicating the switch statements.
...
export interface Severity {
  ...
  glow: boolean         // critical-only 1px box-shadow
}
