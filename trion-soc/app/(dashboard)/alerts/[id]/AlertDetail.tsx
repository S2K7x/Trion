      ...
      <div className="max-w-3xl mx-auto w-full flex flex-col gap-5">
        ...
        >
          <div
            ...
            style={{ color: sevText, letterSpacing: '-0.02em' }}
          >
            {sevLabel}
          </div>
          <div
        ...
        <div className="fade-up-3">
          <Card title="What happened?" accent={sevBg}>
            <p
              className="text-[18px] font-semibold leading-snug m-0"
              style={{
                color: 'var(--text)',
            ...
            {lv?.reason && (
              <p
                className="font-mono text-[12px] mt-3 m-0"
                style={{ color: 'var(--muted)' }}
              >
                {lv.reason}
              </p>
        ...
        <div className="fade-up-5">
          <Card title="What should you do?" accent={sevBg}>
            {lv?.verdict === 'benign' ? (
              ...
              <p
                className="text-[15px] leading-relaxed m-0 font-semibold"
                style={{ color: 'var(--text)' }}
              >
          ...
          >
            ...
            {expanded && (
              ...
              >
                ...
                {lv?.llm_error && (
                  <div
                    className="mt-4 rounded-[8px] px-3 py-2 font-mono text-[11px] flex items-center gap-2"
                    style={{
                  ...
                  >
                    <span>⚙</span>
                    <span>Analysis generated without AI assistance (template-based)</span>
                  </div>
                )}

                {/* Metadata grid */}
                <div
                  className="mt-4 grid grid-cols-2 gap-x-8 gap-y-3"
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  >
                    <div
                      style={{
                        width: `${Math.min(100, ((alert.rule_level ?? 0) / 15) * 100)}%`,
                        background: sevBg,
                        borderRadius: 4,
                        height: '100%',
            ...
            <div className="flex flex-col gap-2">
              {similar.map((s) => (
                ...
                >
                  ...
                  <span
                    className="font-mono text-[11px] shrink-0 ml-4"
                    style={{ color: 'var(--muted)' }}
                  >
